...
export const YearView: React.FC<YearViewProps> = ({ currentDate, tasks, onMonthSelect }) => {
    ...
    return (
        <div className="h-full overflow-y-auto bg-slate-950 scrollbar-hide relative">
            <div className="sticky top-0 z-10 bg-slate-950 border-b border-white/10 shadow-lg shadow-black/20 py-4 px-6 mb-6">
                <h2 className="text-3xl font-bold text-slate-200 w-full text-center">
