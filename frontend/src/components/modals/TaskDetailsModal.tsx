            ...
            {isOpen && (
                <>
                    ...
                    <motion.div
                        ...
                        className="fixed left-1/2 -translate-x-1/2 top-24 w-full max-w-md bg-[#1e293b] border border-white/10 rounded-2xl shadow-2xl z-50 p-6 max-h-[85vh] overflow-y-auto"
                    >
                        <div className="flex items-center justify-between mb-6">
                            <h2 className="text-xl font-bold text-white">Edit Task</h2>
                            <div className="flex gap-2">
                                <button onClick={handleDelete} className="text-red-400 hover:text-red-300 transition-colors p-1">
